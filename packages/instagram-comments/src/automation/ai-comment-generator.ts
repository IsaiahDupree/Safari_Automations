...
const DEFAULT_CONFIG: AICommentConfig = {
  ...
  maxLength: 100,
  temperature: 0.85,
  style: 'supportive',  // Instagram is more supportive/engaging
};

// Instagram-specific platform vibe
const INSTAGRAM_VIBE = 'supportive and engaging';

export class InstagramAICommentGenerator {
