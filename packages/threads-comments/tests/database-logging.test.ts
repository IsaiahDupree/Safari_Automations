...
describe('Database API Endpoints', () => {
  it('GET /api/threads/db/stats should return stats', async () => {
    const response = await fetch(`${API_BASE}/api/threads/db/stats`);
  ...
  it('GET /api/threads/db/history should return history', async () => {
    const response = await fetch(`${API_BASE}/api/threads/db/history?limit=5`);
