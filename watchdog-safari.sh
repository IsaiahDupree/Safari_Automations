...
# SERVICES[3102]="packages/tiktok-dm/src/api/server.ts"  # deferred 2026-03-04
SERVICES[3105]="packages/linkedin-automation/src/api/server.ts"
SERVICES[3005]="packages/instagram-comments/src/api/server.ts"
# SERVICES[3006]="packages/tiktok-comments/src/api/server.ts"  # deferred 2026-03-04
...
while true; do
  for port in 3100 3003 3105 3005 3007 3004 3106; do
